...
public enum EnumProtocol {
    ...
    protected void registerPacket(EnumProtocolDirection enumprotocoldirection, Class<? extends Packet<?>> oclass) {
        Object object = this.j.get(enumprotocoldirection);

        if (object == null) {
            object = HashBiMap.create();
            this.j.put(enumprotocoldirection, (BiMap<EnumProtocolDirection, Class<? extends Packet<?>>>) object);
        }
