...
public interface Packet<T extends PacketListener> {
     ...
     */
    void readPacketData(PacketDataSerializer serializer) throws IOException; // Nacho - OBFHELPER
    default void a(PacketDataSerializer serializer) throws IOException { readPacketData(serializer); }

    /**
     * Writes the raw packet data to the data stream.
     */
    void writePacketData(PacketDataSerializer serializer) throws IOException; // Nacho - OBFHELPER
    default void b(PacketDataSerializer serializer) throws IOException { writePacketData(serializer); }

    /**
     * Passes this packet on to the NetHandler for processing.
     */
    void processPacket(T t0); // Nacho - OBFHELPER
