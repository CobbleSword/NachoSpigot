...
public class PlayerChunkMap {
    ...
    private final Queue<PlayerChunkMap.PlayerChunk> e = new java.util.concurrent.ConcurrentLinkedQueue<>(); // updatingChunks // CraftBukkit ArrayList -> ConcurrentLinkedQueue
    private final Queue<PlayerChunkMap.PlayerChunk> f = new java.util.concurrent.ConcurrentLinkedQueue<>(); //  visibleChunks // CraftBukkit ArrayList -> ConcurrentLinkedQueue
    private int g;
    private long h;
